                                    ...
                                    <div class="p-5">
                                        ...
                                        <form class="user">
                                            <div class="form-group">
                                                <label for="exampleInputSize" class="ml-2 col-form-label p-0">category
                                                    *</label>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputSize" class="ml-2 col-form-label p-0">Name
                                                    *</label>
                                                <input type="text" name="name" class="form-control "
                                                       id="exampleInputEmail" v-model="name"
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputSize" class="ml-2 col-form-label p-0">Color </label>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputSize" class="ml-2 col-form-label p-0">Price
                                                    *</label>
                                            ...
                                            <a href="#" @click="updateProduct()" class="btn btn-primary btn-user btn-block">
                                                Update
                                            </a>
                                        </form>
...
<script setup>
    ...
    onMounted(() => {
        ...
        axios.post('/api/product-edit/'+id.value,{},{headers})
            .then((res)=>{

                name.value = res.data.products.name
                size.value = res.data.products.size
                color.value = res.data.products.color
                description.value = res.data.products.description
                price.value = res.data.products.price
                category.value = res.data.products.category
                discount.value = res.data.products.discount
            }).then((err)=>{
            console.log(err)
        })
    });
    ...
    function updateProduct() {
        ...
        axios.post('/api/product-update/'+id.value, {
